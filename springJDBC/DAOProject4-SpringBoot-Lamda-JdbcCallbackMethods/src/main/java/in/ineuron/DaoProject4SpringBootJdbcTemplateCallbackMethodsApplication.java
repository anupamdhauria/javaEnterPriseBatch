...
public class DaoProject4SpringBootJdbcTemplateCallbackMethodsApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext context = SpringApplication.run(DaoProject4SpringBootJdbcTemplateCallbackMethodsApplication.class, args);
