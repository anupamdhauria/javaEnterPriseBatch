...
public class CustomerController {
	...
	public ResponseEntity<Customer> showAllCustomer(@PathVariable("id") Integer Id){
		System.out.println("Customer data for id::"+Id);
		Customer customer = new Customer();
		customer.setCno(Id);
		customer.setCname("sachin");
		customer.setBillAmount(54.5f);
		customer.setTeamNames(new String[] {"MI","RCB","CSK"});
